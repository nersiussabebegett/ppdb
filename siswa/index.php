      ...
      <div class="main-wrapper main-wrapper-1">
          ...
          <aside id="sidebar-wrapper">
			...
			<div class="menu-header">
				...
				<ul>
					...
					<li>
						<a style="color:#f27907" href="logout.php" class="btn-logout"> <span class="fa fa-sign-out-alt  "></span><br>Logout</a>
					</li>
				</ul>
			</div>
        ...
        <footer class="main-footer">
          ...
          <div class="footer-right">
			<a href="https://<?= $setting['web'] ?>">All Serve <span class="glyphicon glyphicon heart"></span></a>
          </div>
        </footer>
      </div>
    </div>
