...
<div class='row'>
							...
							<div class="col-lg-3">
								<div class="small-box bg-green">
									<div class="inner">
										<h3> <?= rowcount($koneksi, 'daftar', ['status' => 1]) ?></h3>
										<p>Siswa Diterima</p>
									</div>
									<div class="icon">
										<i class="fa fa-school"></i>
									</div>
									<a href="?pg=diterima" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
                            <div class="col-lg-3 ">
                                <div class="small-box bg-red">
                                    <div class="inner">
                                        <h3><?= rowcount($koneksi, 'daftar', ['status' => 2]) ?></h3>
                                        <p>Siswa Cadangan</p>
                                    </div>
                                    <div class="icon">
                                        <i class="fa fa-edit"></i>
                                    </div>
                                    <a href="?pg=ditolak" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                                <div class="col-lg-3">
                                <div class="small-box bg-yellow">
                                    <div class="inner">
                                        <h3><?= rowcount($koneksi, 'daftar', ['konfirmasi' => 1]) ?></h3>
                                        <p>Daftar Ulang</p>
                                    </div>
                                    <div class="icon">
                                        <i class="fa fa-newspaper"></i>
                                    </div>
                                    <a href="?pg=df_ulang" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
							</div>
...
<div class="section-body" id="form-setting">
            ...
            <p class="section-lead">
             Data Pendaftar Siswa Baru Tahun <?= date('Y') ?>
