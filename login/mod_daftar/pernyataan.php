...
<html>
   ...
   <p>Yang bertanda tangan dibawah ini, saya:</p>
		...
		<br>
		<p>Dengan ini menyatakan bahwa saya Mendaftar di SMA Negeri 1 Siberut Selatan Sanggup mengikuti semua Aturan Aturan yang berlaku di di SMA Negeri 1 Siberut Selatan</p>
		<p>Apabila dikemudian Hari Saya melanggar Aturan di SMA Negeri 1 Siberut Selatan, Saya siap untuk menerima sangsi sesui aturan yang berlaku di SMA Negeri 1 Siberut Selatan</p>
		<p>Demikian Surat pernyataan ini dibuat sebagai tanda keseriusan saya untuk belajar di SMA Negeri 1 Siberut Selatan</p>
		...
		<table width="100%" cellpadding="1" cellspacing="0" border="0">
			...
			<tr><td></td></tr>
			<tr align="left">
				<td align="right">Maileppet,<?= date('d-M-Y ') ?></td>
			</tr>
<tr><td>.</td></tr>
<tr><td>.</td></tr>
