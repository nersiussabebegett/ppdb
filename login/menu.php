 <?php
    ...
    <?php if ($user['level'] == 'admin') { ?>
		<li class="dropdown ">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-home fa-fw"></i> <span>Master Sekolah</span></a>
            <ul class="dropdown-menu">
                <li><a class="nav-link" href="?pg=profil_lembaga">Profil Sekolah</a></li>
                <li><a class="nav-link" href="?pg=sekolah">Data Sekolah</a></li>
                <!------------
                <li><a class="nav-link" href="?pg=kelas">Data Kelas</a></li>
				<li><a class="nav-link" href="?pg=guru">Data Guru</a></li>
				<li><a class="nav-link" href="?pg=alumni">Data Alumni</a></li>
               
               
            </ul>
        </li>
		<li class="dropdown ">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-user fa-fw"></i> <span>Kesiswaan</span></a>
            <ul class="dropdown-menu">
                <li><a class="nav-link" href="?pg=siswa">Siswa Aktif</a></li>

                <li><a class="nav-link" href="?pg=luluskan">Luluskan Siswa</a></li>
                <li><a class="nav-link" href="?pg=masuk">Mutasi Masuk</a></li>
                <li><a class="nav-link" href="?pg=pindah">Mutasi Keluar</a></li>
				------->
            </ul>
        </li>
    ...
    <li class="dropdown ">
        ...
        <ul class="dropdown-menu">
            <li><a class="nav-link" href="?pg=daftar">Data Pendaftar</a></li>
	...
	<?php if ($user['level'] == 'admin') { ?>
        <li class="dropdown ">
            ...
            <ul class="dropdown-menu">
				<li><a class="nav-link" href="?pg=l_ppdbyes">Data PPDB Diterima</a></li>
		...
		<li class="dropdown ">
         ...
         <li>
            <a style="#" href="logout.php" class="btn-logout">
