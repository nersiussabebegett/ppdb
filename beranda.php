                    ...
                    <nav class="navbar navbar-expand-lg navbar-light" id="navbar-header">
                        <a class="navbar-brand" href="javascript:;">
                            ...
                            <div class="home-header-text d-none d-sm-block">
                                ...
                                <h4><?= $setting['nama_sekolah'] ?></h4>
                                <h6>Jl. Maileppet Kecamatan Siberut Selatan</h6>
                                <h6>Tahun Ajaran 2021/2022</h6>
                            </div>
                            <span class="logo-mini-unbk d-block d-sm-none">PPDB ONLINE</span>
                            <p>
                            <span class="logo-mini-tahun d-block d-sm-none"></span>
                        </a>
                                    ...
                                    <div class="carousel-item active">
                                        <div>
                                            ...
                                            <p data-animation="animated slideInRight" data-delay="2s">
                                                Pendaftaran Siswa dan Siswi Baru Tahun 2021 ini telah dibuka. Silahkan Segera Daftar dan lengkapi Formulir
                                            </p>
                                    ...
                                    <div class="carousel-item">
                                        <div>
                                            ...
                                            <ul>
                                                ...
                                                <li data-animation="animated flipInX" data-delay="4s">
                                                    Konfirmasi Pendaftaran (Daftar Ulang)
                                                </li>
                                                <li data-animation="animated flipInX" data-delay="5s">
                                                    Cetak Pendaftaran
                                                </li>
						...
						<div class="col-sm-8">
                                    ...
                                    <div class="carousel-item active">
                                        <div>
                                            ...
                                            <p data-animation="animated slideInRight" data-delay="2s">
                                                Pendaftaran Siswa dan Siswi Baru Tahun 2021/2022 ini Belum Dibuka.
                                            </p>
                                            <p data-animation="animated flipInX" data-delay="3s">
...
<?php } ?>
                <section class="bg-light statistik" id="statistik">
                    <div class="container">
                        ...
                        <h6 class="text-center">Peserta Didik Baru <?= $setting['nama_sekolah'] ?> Tahun 2021</h6>
                        <div class="row mt-12">
                            <div class="col-sm-4">
                                <div class="card mt-2">
                            ...
                            <div class="col-sm-4">
                                <div class="card mt-2">
                                    <div class="card-header bg-secondary">Siswa Terdaftar</div>
                                    <div class="card-body">
                                        <h2 class="text-center"><?= rowcount($koneksi, 'daftar', ['status' => 1]) ?></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
